...
keymap.set({ "n", "i" }, "<F5>", "<cmd>ToggleTerm direction=float<CR>", { silent = true })

keymap.set("n", "<c-P>", "<cmd>lua require('telescope.builtin').find_files{}<CR>", { silent = true })
keymap.set("n", "<c-G>", "<cmd>lua require('telescope.builtin').live_grep{}<CR>", { silent = true })
keymap.set("n", "<c-B>", "<cmd>lua require('telescope.builtin').buffers{}<CR>", { silent = true })
keymap.set("n", "<c-H>", "<cmd>lua require('telescope.builtin').help_tags{}<CR>", { silent = true })
keymap.set({"n", "v"}, "<C-/>", "<cmd>Commentary<CR>")
