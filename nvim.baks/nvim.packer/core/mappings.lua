...
keymap.set("n", "<c-G>", "<cmd>lua require('fzf-lua').live_grep{}<CR>", { silent = true })

keymap.set("n", "<c-B>", "<cmd>lua require('fzf-lua').buffers{}<CR>", { silent = true })
keymap.set("n", "<c-H>", "<cmd>lua require('fzf-lua').help_tags{}<CR>", { silent = true })
keymap.set("n", "<C-/>", "<cmd>Commentary<CR>")
