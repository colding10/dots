...
--                 fg = GRAY
--             },
--             NvimTreeFolderIconOpen = {
--                 fg = GRAY
--             },
--             NvimTreeFolderSymlink = {
--                 fg = GRAY
--             },
--             NvimTreeDefault = {
--                 fg = GRAY
...
--             icon.color = GRAY
--             new_icons[key] = icon
--             overrides["BufferLineDevIcon" .. icon.name] = {
--                 bg = BG,
--                 fg = FADED_GRAY
--             } -- unactive tabs to faded gray
--             overrides["BufferLineDevIcon" .. icon.name .. "Selected"] = {
--                 bg = BG,
--                 fg = GRAY
--             } -- active tabs to gray
--         end
